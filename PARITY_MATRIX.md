...
| Creatures | Source traced for the three descriptor forms, the known-creature table and creature relocation | Descriptors, the known-creature mirror and creature moves decoded; the 140-145 update commands not started | No | `INITIALWORLD-772-001` and `MOVEMENT-772-001` PASS; live visible creature set matched the server with no phantoms | No | IN_PROGRESS |
