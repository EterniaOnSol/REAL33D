...
Current milestone: `TWO-CLIENT-VERTICAL-SLICE-001` (`PASS` for one bounded live run; independent repetition and retained screenshots pending)
Branch: `main`
...
Latest functional tests: classic baseline IDs, `CLIENTCORE-TRANSPORT-772-001`, `CLIENTCORE-CRYPTO-772-001`, `CLIENTCORE-LOGIN-772-001`, `CLIENTCORE-GAMELOGIN-772-001`, `INITIALWORLD-772-001`, `MOVEMENT-772-001`, `PLAYERSTATE-772-001` and `TWO-CLIENT-VERTICAL-SLICE-001` are `PASS`
